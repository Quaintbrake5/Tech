                ...
                <div className='footer-links-table'>
                    ...
                    <div className='footer-links'>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="/careers" className="link">Features</a>
                            </li>
                            <li>
                                <a href="https://thewcommunity.com" className="link">Pricing</a>
                            </li>
                            <li>
                                <a href="/corporate/corporate-sector" className="link">Tutorials</a>
                            </li>
                            <li>
